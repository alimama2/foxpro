...
sed -i 's/\"nginx/\"FoxPro Beta/i' /tmp/tengine-1.4.6/src/core/nginx.h
sed 's/>nginx</>FoxPro Beta</' -i /tmp/tengine-1.4.6/src/http/ngx_http_special_response.c
sed -i 's/\" NGINX_VER \"/FxoPro beta/' /tmp/ngx_cache_purge-2.1/ngx_cache_purge_module.c
